...
function Label({ children, style = {} }) {
  return <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: T.textSec, ...style }}>{children}</div>;
}
...
export default function TabRelatorios({ kpis, leads, viewLabel }) {
  ...
  const getReport = (mk) => {
    ...
    return { ...agg, convLeadsCRM, totalCRM, fat, month: m, year: y };
  };
